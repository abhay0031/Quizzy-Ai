...
const CreateQuiz = () => {
  ...
  useEffect(() => {
    if (edit && quiz) {
      ...
      setValue("semester", quiz.semester)
    ...
    <div className='min-h-[70vh] flex justify-center flex-col items-center gap-10'>
      ...
      <form onSubmit={handleSubmit(submitHandler)} className='w-full max-w-[480px] border mx-auto py-10 flex flex-col gap-5 p-10 rounded-lg shadow-lg shadow-blue-400'>
        ...
        <span className='flex flex-col gap-2'>
          ...
          />
          {
            errors.semester && <RequiredError>{errors.semester.message}</RequiredError>
          }
        </span>
        ...
        <span className='flex flex-col gap-2'>
          ...
          <input
            type="text"
            placeholder='Enter Subject Type (e.g. OS, CN)'
            id='type'
            {
          ...
          />
          {
            errors.type && <RequiredError>{errors.type.message}</RequiredError>
          }
        </span>
